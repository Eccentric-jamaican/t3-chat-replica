            ...
            <Tabs defaultValue={search.tab || "profile"} className="w-full">
              ...
              <TabsContent value="connections" className="space-y-6">
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    {/* Gmail Connection */}
                    <div className="flex flex-wrap items-center justify-between gap-3 p-4 rounded-xl bg-black/[0.02] border border-black/5">
                      <div className="flex items-center gap-3 min-w-0 flex-1">
                        ...
                        <div className="min-w-0">
                          ...
                          {gmailStatus?.connected ? (
                            <div className="min-w-0">
                              <p className="text-xs text-foreground/50 truncate max-w-[180px]">{gmailStatus.email}</p>
