    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          title="Open search"
          className="fixed right-6 bottom-8 z-[100] rounded-full bg-primary p-5 text-white shadow-2xl transition-all hover:scale-105 hover:bg-primary/90 active:scale-95"
